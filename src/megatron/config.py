...
# Global configuration object with default values available for the entire project
# while running session. Available to update at any time using the set_config function.
@dataclass
class Config:
